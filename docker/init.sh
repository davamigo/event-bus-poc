...
docker exec -it event_bus_basket_database mysql -uroot -proot -D basket_service \
    -e "CREATE TABLE IF NOT EXISTS basket_service.user (id INT NOT NULL, global_id INT NOT NULL DEFAULT 0, PRIMARY KEY (id));"
